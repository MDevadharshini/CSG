...
import imgName from "./Img/dtp.jpg";
import photoshopLogo from "./Img/graph4.jpg";
import AdobePic from "./Img/dtp2.png";
...
const topics = [
  {
    ...
    description: "Understand the basics of desktop publishing and its applications."
  },
  {
    icon: <FaFont />,
    title: "Typography & Layout",
    description: "Learn to design effective text layouts and font usage for print media."
  },
  {
    icon: <FaLayerGroup />,
    title: "Page Design & Composition",
    description: "Arrange text, images, and graphics to create balanced page layouts."
  },
  {
    icon: <FaFileExport />,
    title: "Graphic Integration",
    description: "Incorporate vector and raster graphics seamlessly into your designs."
  },
  {
    icon: <FaMagic />,
    title: "Color Management",
    description: "Manage color profiles for accurate printing results."
  },
  {
    icon: <FaFileImage />,
    title: "Printing & Exporting",
    description: "Prepare files correctly for professional printing and digital distribution."
  }
];
...
const usageAreas = [
  {
    icon: <FaPaintBrush />,
    title: "DTP Fundamentals",
    description: "Learn the essentials of desktop publishing and print media workflows."
  },
  {
    icon: <FaFont />,
    title: "Typography & Fonts",
    description: "Explore typefaces, font pairing, and text formatting for effective communication."
  },
  {
    icon: <FaFileExport />,
    title: "Layout & Page Design",
    description: "Create professional multi-page documents with balanced text and visuals."
  },
  {
    icon: <FaMagic />,
    title: "Graphic Integration",
    description: "Combine images, graphics, and text for eye-catching publications."
  },
  {
    icon: <FaFileImage />,
    title: "Prepress & Color Management",
    description: "Prepare files for printing with color accuracy and bleed settings."
  },
  {
    icon: <FaRunning />,
    title: "Publishing & Distribution",
    description: "Understand digital and print publishing processes and file export formats."
  }
];
...
>
  ...
  >
    ...
    <p
      ...
      data-aos-delay="300"
    >
     Learn to design and produce professional-quality printed and digital materials, 
  combining text and graphics seamlessly with powerful desktop publishing tools.
    </p>
  </div>
</section>
...
<section style={{ padding: 0, margin: 0, textAlign: "center" }}>
  ...
  >
    Desktop Publishing (DTP) enables the creation and arrangement of text and graphics using specialized software to design professional documents like brochures, magazines, and flyers. In real time, it allows designers to visually compose layouts, apply styles, and instantly preview print-ready outputs before final production.
  </p>
</section>
