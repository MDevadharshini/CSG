...
<<<<<<< HEAD
        ...
        <li className=" dropdown-item-5"><a  href="#"> Adobe Photoshop 5</a></li>
        <li className=" dropdown-item-5"><a  href="#"> Flash</a></li>
        <li className=" dropdown-item-5"><a  href="#"> CorelDRAW</a></li>
