...
import Img from '../Img/Tally-1.jpg';
...
const curriculum = [
  { title: "Introduction to Tally & Accounting Basics", icon: Book },
  { title: "Company Creation & Configuration", icon: FileText },
  { title: "Voucher Entry & Transactions", icon: Calculator },
  { title: "Inventory Management in Tally", icon: BarChart2 },
  { title: "GST & Taxation in Tally", icon: Banknote },
  { title: "Payroll Management", icon: FileText },
  { title: "Financial Reports & Analysis", icon: BarChart2 },
  { title: "Final Project – Business Accounting Simulation", icon: Building2 },
];
...
const faqs = [
  {
    ...
    answer: "Yes, we start from the basics of accounting and Tally. No prior experience needed.",
  },
  {
    question: "Will I learn GST and other taxation modules?",
    answer: "Absolutely! We cover GST, TDS, and other taxation features in Tally.",
  },
  {
    question: "Do you provide placement assistance?",
    answer: "Yes, we provide job referrals, interview preparation, and resume guidance.",
  },
];
...
>
  <div className="container">
    ...
    Master Tally with practical projects, real-world accounting scenarios, and expert guidance from industry professionals.
    </p>
    ...
    >
      ...
      >
        ...
        <ul className="list-unstyled mt-3">
          {[
           { icon: <Book />, text: "Gain in-depth knowledge of Tally for accounting" },
{ icon: <Calculator />, text: "Build a career in finance, accounting, and taxation" },
{ icon: <BarChart2 />, text: "Master GST, payroll, and inventory management in Tally" },
{ icon: <Banknote />, text: "Apply Tally skills in real-world business scenarios" }
...
<section
  ...
  style={{
    backgroundImage: `url(${require("../Img/Tally-2.jpg")})`,
    backgroundSize: "cover",
    backgroundPosition: "center",
