...
export default function CourseTemplate() {
  ...
  const curriculum = [
  { title: "Introduction to CAD Principles", icon: Book },
  { title: "2D Drafting Techniques", icon: FileText },
  { title: "3D Modeling Fundamentals", icon: Box },  // replaced Cube with Box
  { title: "CAD Software Mastery", icon: Monitor },
  { title: "Design Simulation & Analysis", icon: Activity },
  { title: "Industry Design Standards", icon: Award },
  { title: "Collaborative Project Work", icon: Users },
  { title: "Portfolio & Final Presentation", icon: Award },
];
  ...
  const faqs = [
    {
      question: "Is this CAD course suitable for beginners?",
      answer:
        "Yes, the course starts with fundamental concepts and gradually advances, so no prior CAD experience is required.",
    },
    {
      question: "Which CAD software will I learn?",
      answer:
        "You will get hands-on training with popular tools like AutoCAD, SolidWorks, and Fusion 360.",
    },
    {
      question: "Will there be real-world design projects?",
      answer:
        "Definitely! The course includes practical projects that simulate industry design challenges.",
    },
    {
      question: "Do you offer placement assistance for CAD roles?",
      answer:
        "Yes, we provide career guidance, resume building, and connect you with industry partners for job opportunities.",
    },
  ];
...
>
  <div className="container">
    ...
    <p className="lead mb-4 hero-text">
      Unlock your creativity and technical expertise through immersive CAD projects, practical industry scenarios, and mentorship from seasoned design engineers.
    </p>
    ...
    >
      ...
      >
        ...
        <ul className="list-unstyled mt-3">
          {[
           { icon: <Book />, text: "Master core concepts of Computer-Aided Design" },
{ icon: <Calculator />, text: "Unlock lucrative engineering and design career paths" },
{ icon: <BarChart2 />, text: "Gain hands-on experience with modern CAD tools and workflows" },
{ icon: <Banknote />, text: "Work on real-world projects to showcase your CAD expertise" }
...
<section
  ...
  style={{
    backgroundImage: `url(${require("../Img/cad3.jpg")})`,
    backgroundSize: "cover",
    backgroundPosition: "center",
