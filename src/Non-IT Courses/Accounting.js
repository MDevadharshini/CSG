...
export default function CourseTemplate() {
  ...
  const curriculum = [
    { title: "Basics & Fundamentals", icon: Book },
    { title: "Advanced Concepts", icon: FileText },
    { title: "Practical Applications", icon: Calculator },
    { title: "Software & Tools", icon: BarChart2 },
    { title: "Industry Standards", icon: Banknote },
    { title: "Project Work", icon: FileText },
    { title: "Analysis & Reports", icon: BarChart2 },
    { title: "Final Project Showcase", icon: Building2 },
  ];
  ...
  const faqs = [
    {
      ...
      answer: "Yes, we start from the fundamentals. No prior experience needed.",
    },
    {
      question: "Will I learn practical tools?",
      answer: "Absolutely! You’ll master industry-relevant software and techniques.",
    },
    {
      question: "Do you provide placement assistance?",
      answer: "Yes, we offer job referrals and interview preparation support.",
    },
  ];
...
>
  <div className="container">
    ...
    <h1 className="display-3 fw-bold mb-3 metallic-heading">
      {"Accounting Course".split("").map((char, i) => (
    ...
    <p className="lead mb-4 hero-text">
      Master the art of financial management and strategic decision-making through hands-on accounting projects, real-world business case studies, and guidance from experienced finance professionals.
    </p>
    ...
    >
      ...
      >
        ...
        <ul className="list-unstyled mt-3">
          {[
            { icon: <Book />, text: "Builds essential industry knowledge" },
            { icon: <Calculator />, text: "Opens high-paying opportunities" },
            { icon: <BarChart2 />, text: "Learn modern tools and techniques" },
            { icon: <Banknote />, text: "Apply skills in real-world scenarios" }
          ].map((item, index) => (
            <li
              key={index}
...
<section
  ...
  style={{
    backgroundImage: `url(${require("../Img/Acc-img.jpg")})`,
    backgroundSize: "cover",
    backgroundPosition: "center",
