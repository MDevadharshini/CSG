...
import Img from '../Img/mechcad1.jpg';
import {
  Book,
  Calculator,
  FileText,
...
export default function CourseTemplate() {
  ...
  const curriculum = [
  { title: "Mechanical Design Fundamentals", icon: Book },
  { title: "Advanced 3D Modeling Techniques", icon: FileText },
  { title: "Material Properties & Mechanics", icon: Calculator },
  { title: "CAD Software Mastery (AutoCAD, SolidWorks)", icon: BarChart2 },
  { title: "Industry Design Standards & Compliance", icon: Banknote },
  { title: "Hands-on Mechanical Design Projects", icon: FileText },
  { title: "Simulation & Stress Analysis", icon: BarChart2 },
  { title: "Capstone Project & Portfolio Presentation", icon: Building2 },
];
  ...
  const faqs = [
  {
    question: "Is this Mechanical CAD course suitable for beginners?",
    answer: "Yes, the course covers fundamental mechanical design concepts and CAD basics, so no prior experience is required.",
  },
  {
    question: "Which CAD software will I learn in this course?",
    answer: "You will get hands-on training with popular mechanical CAD tools like AutoCAD, SolidWorks, and Fusion 360.",
  },
  {
    question: "Will there be real-world mechanical design projects?",
    answer: "Definitely! The course includes practical projects focused on mechanical components and assemblies.",
  },
  {
    question: "Do you offer placement support for Mechanical CAD roles?",
    answer: "Yes, we provide career guidance, resume building, and connect you with industry employers for job opportunities.",
  },
];
...
>
  <div className="container">
    ...
    <h1 className="display-3 fw-bold mb-3 metallic-heading">
      {"Mechanical CAD Course".split("").map((char, i) => (
    ...
    <p className="lead mb-4 hero-text">
     "Develop core mechanical design skills through immersive hands-on projects, real-world engineering case studies, and expert mentorship from seasoned industry professionals."
    </p>
  ...
  <style>
    {`
      ...
      .metallic-heading span {
        ...
        animation: fadeUp 0.5s forwards, metallicShift 4s linear infinite;
      }
    ...
    >
      ...
      >
        ...
        <ul className="list-unstyled mt-3">
          {[
            { icon: <Book />, text: "Master the fundamentals of Mechanical CAD design" },
{ icon: <Calculator />, text: "Pursue high-paying roles in mechanical engineering and product design" },
{ icon: <BarChart2 />, text: "Work with industry-standard CAD tools for mechanical projects" },
{ icon: <Banknote />, text: "Design real-world mechanical components and assemblies" }
...
<section
  ...
  style={{
    backgroundImage: `url(${require("../Img/mechcad2.jpg")})`,
    backgroundSize: "cover",
    backgroundPosition: "center",
